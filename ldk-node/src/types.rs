...
impl From<LdkChannelDetails> for ChannelDetails {
    fn from(value: LdkChannelDetails) -> Self {
        ChannelDetails {
            ...
            funding_txo: value
                .funding_txo
                .and_then(|o| Some(o.into_bitcoin_outpoint())),
...
impl ToSocketAddrs for NetAddress {
    ...
    fn to_socket_addrs(&self) -> std::io::Result<Self::Iter> {
        match self.0 {
            ...
            LdkNetAddress::Hostname { ref hostname, port } => Ok((hostname.as_str(), port)
                .to_socket_addrs()?
                .next()
                .into_iter()),
...
impl ChannelConfig {
    ...
    pub fn set_forwarding_fee_proportional_millionths(&self, value: u32) {
        self.inner
            .write()
            .unwrap()
            .forwarding_fee_proportional_millionths = value;
    }
    ...
    pub fn set_force_close_avoidance_max_fee_satoshis(&self, value_sat: u64) {
        self.inner
            .write()
            .unwrap()
            .force_close_avoidance_max_fee_satoshis = value_sat;
    }
